    ...
    >
      ...
      >
        <div className="flex flex-col items-center gap-2 shrink-0">
          <div
            className={`h-12 w-12 rounded-xl flex items-center justify-center font-bold font-display text-lg ${
              candidate.rank <= 3
                ? "bg-gradient-to-br from-cyber to-neon text-background glow-cyber"
            ...
            <div className="min-w-0">
              ...
              <div className="mt-1.5 flex items-center gap-3 text-xs text-muted-foreground">
                <span className="inline-flex items-center gap-1">
                  ...
                  {p.years_of_experience}y experience
                </span>
          ...
          >
            <div className="p-5 space-y-5">
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                ...
                <Meta
                  label="Experience"
                  value={`${p.years_of_experience} years`}
                />
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <Score
                    ...
                    value={candidate.role_fit_score}
                  />

                  <Score
                    label="Skills Score"
                    value={candidate.skills_score}
                  />

                  <Score
                    label="Location Score"
                    value={candidate.location_score}
                  />
                </div>
              </div>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {p.skills.map((s, i) => (
                      <Badge
                        key={`${s}-${i}`}
                        className="bg-cyber/10 text-cyber border border-cyber/20 font-normal"
                      >
                        {s}
                      </Badge>
                    ))}
  ...
  return (
    <div>
      <div className="flex items-center justify-between text-sm mb-1.5">
        ...
        <span className="font-mono font-semibold text-cyber">
          {v}%
        </span>
      </div>
